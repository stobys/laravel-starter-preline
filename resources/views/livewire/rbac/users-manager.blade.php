<div>
    ...
    <section>
        <div class="mx-auto w-full shadow-sm rounded-lg mb-4 border border-gray-200 dark:border-gray-700">
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex-row items-center justify-between p-4 sm:flex sm:space-y-0 sm:space-x-4 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h5 class="mr-3 font-semibold dark:text-gray-300">Role Based Access Control : Users</h5>
                        <p class="text-adient-teal-3 dark:text-gray-400 text-sm">Manage all your existing users or add a new one</p>
                    </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400 opacity-70">
                            <tr>
                                ...
                                <th wire:click="sortBy('last_name')" scope="col" class="px-4 py-3 cursor-pointer">
                                ...
                                <th wire:click="sortBy('department')" scope="col" class="px-4 py-3 cursor-pointer">
                                    <p class="antialiased flex items-center justify-between gap-2 leading-none">
                                        Department
                                ...
                                <th wire:click="sortBy('username')" scope="col" class="px-4 py-3 cursor-pointer">
                                    <p class="antialiased flex items-center justify-between gap-2 leading-none">
                                        Username
                                ...
                                <th wire:click="sortBy('employee_number')" scope="col" class="px-4 py-3 cursor-pointer">
                                    <p class="antialiased flex items-center justify-between gap-2 leading-none">
                                        Employee Number
                                ...
                                <th wire:click="sortBy('email')" scope="col" class="px-4 py-3 cursor-pointer">
                                    <p class="antialiased flex items-center justify-between gap-2 leading-none">
                                        Email
                        ...
                        <tbody>
                            ...
                            <tr @class([
                                    ...
                                    'text-gray-900 dark:text-gray-100' => !$user->trashed(),
                                    'text-red-900 dark:text-red-100 bg-red-200 dark:bg-red-500' => $user->trashed(),
                                ])
                            >
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    {{ $user->department?->abbr }} - {{ $user->department?->name }}
                                    {{-- <x-form.checkbox /> --}}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    {{ $user->username }}
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    @unless($user?->is_system_user)
                                        <x-button.outline wire:click="openEditModal({{ $user->id }})" class="me-2">
                                        ...
                                        @if( $user->trashed() )
                                            <x-button.outline wire:click="restoreUser({{ $user->id }})"
                                        ...
                                        @else
                                            <x-button.outline wire:click="deleteUser({{ $user->id }})"
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">
                                            @if($search)
                                                Nie znaleziono użytkowników dla frazy "{{ $search }}"
                                            @else
        ...
        @includeIf('rbac.partials.user-modal')
    </section>
