<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		title="{{ __('dashboard.labels.q4_budget') }}"
		helper="{{ __('dashboard.labels.q4_budget_helper') }}"
		value="{{ format_as_number($budget->q4_budget) }}">
		<x-slot name="icon">
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_planned_cost) }}">
		<x-slot name="icon">
			<x-feather-dollar-sign class="shrink-0 size-5 text-muted-foreground-2" />
		</x-slot>
	</x-stats.card1>
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_avg_training_planned_cost) }}">
		<x-slot name="icon">
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_avg_planned_cost_per_participant) }}">
		<x-slot name="icon">
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_trainings_count) }}">
		<x-slot name="icon">
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_unique_participants_count) }}">
		<x-slot name="icon">
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_participants_count) }}">
		<x-slot name="icon">
			<x-feather-users class="shrink-0 size-5 text-muted-foreground-2" />
		</x-slot>
	</x-stats.card1>
	...
	<x-stats.card1 class="hover:shadow-lg focus:outline-hidden focus:shadow-lg transition"
		...
		value="{{ format_as_number($budget->q4_budget_planned_utilization_pct, 1) }}%">
		<x-slot name="icon">
...
<div class="grid grid-cols-8 gap-4 sm:gap-6">
	...
	>
		<canvas id="Q4QuarterChart"></canvas>
	</x-card>
