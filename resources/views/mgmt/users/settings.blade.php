...
@section('content')
	...
	<x-form class="flex-1 flex flex-col overflow-hidden">
		...
		<div class="py-3 px-4 flex flex-wrap justify-between items-center gap-2 border-b border-card-line">
			<div>
				<h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">
					{{ __('users.labels.settings-title') }}
				</h2>
				<p class="text-sm text-gray-600 dark:text-neutral-300">
					{{ __('users.labels.settings-title-helper') }}
				</p>
			</div>
		</div>
		<!-- End Header -->
		...
		<div class="flex-1 flex flex-col overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-scrollbar-track [&::-webkit-scrollbar-thumb]:bg-scrollbar-thumb">
			...
			{{-- <livewire:trainings.attachments-manager :training="$training" :viewonly="$action == 'show' ?? false" /> --}}

			{{-- <div class=" bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
			...
			<div x-show="isProfileInfoModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999" style="display: none;">
				...
				<div @click.outside="isProfileInfoModal = false" class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
					...
					<form class="flex flex-col" method="POST" action="{{ route('users.settings') }}">
						@csrf
						@method('PATCH')
							...
							<div class="mt-7">
								...
								<div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
									<div class="col-span-2 lg:col-span-1">
										...
										<input type="text" name="user[first_name]" value="{{ auth()->user()->first_name }}" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
									</div>
									...
									<div class="col-span-2">
										...
										<input type="text" name="profile[bio]" value="{{ auth()->user()->full_name }}" class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
									</div>
								</div>
							</div>
						</div>
