...
<body class="hs-overlay-body-open overflow-hidden bg-background-2">
    ...
    <main class="lg:hs-overlay-layout-open:ps-60 transition-all duration-300 lg:fixed lg:inset-0 pt-13.5 px-3 pb-3">
        <div class="h-[calc(100dvh-62px)] overflow-hidden flex flex-col bg-layer border border-layer-line shadow-xs rounded-lg">
            @yield('content')
        </div>
    </main>
                ...
                (function () {
                    ...
                    globalColorThemeSwitchers.forEach((el) => {
                        ...
                        if (reducedThemes.includes(el.value)) {
                            el.disabled = true;
                            el.closest('.group').classList.add('opacity-50', 'pointer-events-none');
                        }
                        ...
                        el.addEventListener('change', (evt) => {
                            ...
                            brands[0].dispatchEvent(new Event("change", { bubbles: true }));
                        });
                    });
    ...
    @auth
        <livewire:inactivity-watcher :timeout="900" :warning-before="60" />
    @endauth
</body>
</html>
