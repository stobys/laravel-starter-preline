...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        x-data="{ page: 'blank', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': true, 'isProfileInfoModal': false, 'isProfileAddressModal': false }"
    ...
    >
        ...
        <div class="flex h-screen overflow-hidden">
            @includeIf('layout.first.partials.sidebar')

            <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
                @includeIf('layout.first.partials.header')
