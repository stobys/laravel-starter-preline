        ...
        <div class="flex justify-between items-center max-w-screen-2xl mx-auto">
            <div class="flex justify-start items-center">
                <a href="{{ route('home') }}" class="flex mr-14">
                    <img class="dark:hidden mr-3 h-8" src="{{ asset('adient/adn_rgb_grn_pos.png') }}" alt="Logo" />
                    <img class="hidden dark:block mr-3 h-8" src="{{ asset('adient/adn_rgb_grn_rev.png') }}" alt="Logo" />
                </a>

                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1">
                    <ul class="flex flex-col mt-4 space-x-6 text-sm font-medium lg:flex-row xl:space-x-8 lg:mt-0">
                        <li>
                            <a href="{{ route('dashboard') }}" class="block rounded text-primary-700 dark:text-primary-500" aria-current="page">Dashboard</a>
                        </li>
                        <li>
                        ...
                        <li :selected="request()->routeIs('settings.edit')">
                            <a href="{{ route('settings.edit') }}" class="block text-gray-700 hover:text-primary-700 dark:text-gray-400 dark:hover:text-white">
                                {{-- <x-slot name="icon"> --}}
                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar" class="hidden z-20 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                  <li>
                                    <a href="#" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Providers</a>
                                  </li>
                                  <li>
                                    <a href="#" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Trainings</a>
                                  </li>
                                  <li>
