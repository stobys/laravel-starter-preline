...
<p class="my-10 mx-10 text-sm text-right text-gray-500">
    &copy;{{ date('Y') }} <a href="https://connect.adient.com/" class="hover:underline" target="_blank">adient.com</a>
{{-- |
    Dev Stack :
    <a href="https://laravel.com" class="hover:underline" target="_blank">Laravel</a>,
    <a href="https://laravel-livewire.com" class="hover:underline" target="_blank">Livewire</a>,
    <a href="https://alpinejs.dev" class="hover:underline" target="_blank">Alpine.js</a>,
