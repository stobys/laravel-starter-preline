<div id="hs-pro-sidebar" class="hs-overlay [--body-scroll:true] lg:[--overlay-backdrop:false] [--is-layout-affect:true] [--opened:lg] [--auto-close:lg] hs-overlay-open:translate-x-0 lg:hs-overlay-layout-open:translate-x-0 -translate-x-full transition-all duration-300 transform w-60 fixed inset-y-0 z-60 start-0 bg-sidebar-2 lg:block lg:-translate-x-full lg:end-auto lg:bottom-0 open opened" role="dialog" aria-label="Sidebar" style="outline: none;" aria-overlay="true" tabindex="-1">
      <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
        ...
        <nav class="p-3 size-full flex flex-col overflow-y-auto [&amp;::-webkit-scrollbar]:w-2 [&amp;::-webkit-scrollbar-thumb]:rounded-none [&amp;::-webkit-scrollbar-track]:bg-scrollbar-track [&amp;::-webkit-scrollbar-thumb]:bg-scrollbar-thumb">
          <div class="lg:hidden mb-2 flex items-center justify-between">
            ...
            <!-- Sidebar Toggle -->
            <button type="button" class="p-1.5 size-7.5 inline-flex items-center gap-x-1 text-xs rounded-md text-muted-foreground-1 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden" aria-haspopup="dialog" aria-expanded="true" aria-controls="hs-pro-sidebar" data-hs-overlay="#hs-pro-sidebar">
