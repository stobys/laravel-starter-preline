...
<select id="{{ $id }}" name="{{ $name }}" @class([
		"py-2.5 sm:py-3 px-4 block w-full bg-layer rounded-lg sm:text-sm text-foreground placeholder:text-muted-foreground-1 disabled:opacity-50 disabled:pointer-events-none",
